...
<body>
    ...
    <script>
        ...
        const UserGuideModal = ({ show, onClose, currentUser }) => {
            ...
            const sections = {
                introduction: {
                    ...
                    content: [
                        ...
                        "",
                        "⚡ NAVIGATION:",
                        "• 👈 Menu gauche = Sections du guide",
                        "• ⎋ Escape = Fermer ce guide",
                        "",
                        "💡 Parcourez les sections pour tout découvrir!"
                    ]
                },
                connexion: {
                    title: "🔐 Connexion",
                    ...
                    content: [
                        ...
                        "• ☑️ 'Se souvenir de moi' (optionnel)",
                        "",
                        "⏰ DURÉE DE SESSION:",
                        "• ☑️ Coché = 30 jours",
                        "• ☐ Décoché = 7 jours",
                ...
                roles: {
                    ...
                    color: "purple",
                    content: [
                        "📌 VOTRE RÔLE ACTUEL: " + getUserRoleBadge(),
                        "",
                        ...
                        "• Superviseur - Coordination technique",
                        "• Coordonnateur - Planning maintenance",
                        "• Planificateur - Organisation travaux",
                        "",
                        "🔧 TECHNICIENS:",
                        "• Technicien Senior - Expert + formation",
                        "• Technicien - Réparations standards",
                        "",
                        "🏭 PRODUCTION:",
                        "• Chef Équipe - Supervision terrain",
                        "• Opérateur Four - Gestion fours",
                        "• Opérateur - Création tickets",
                        "",
                        "🛡️ SUPPORT:",
                        "• Agent SST - Santé & sécurité",
                        "• Inspecteur Qualité - Contrôles",
                        "• Magasinier - Gestion inventaire",
                        "",
                        "👁️ Lecture Seule - Consultation seulement",
                        "",
                        "💡 14 rôles fixes = permissions adaptées"
                    ]
                },
                kanban: {
                    ...
                    content: [
                        ...
                        "2️⃣ 🟨 Diagnostic - Analyse du problème",
                        "3️⃣ 🟧 En Cours - Réparation active",
                        "4️⃣ 🟪 Attente Pièces - Commande pièces",
                        "5️⃣ 🟩 Terminé - Travail complété",
                        "6️⃣ ⬜ Archivé - Fermé définitivement",
                        "",
                        "🖱️ DÉPLACER UN TICKET:",
                        "• 💻 PC: Glisser-déposer la carte",
                        "• 📱 Mobile: Tap carte → Menu statut",
                        "",
                        "⚡ COULEURS PRIORITÉ:",
                        "• 🔴 Rouge = Critique",
                        "• 🟠 Orange = Élevée",
                ...
                creer_ticket: {
                    ...
                    content: [
                        "🆕 NOUVEAU TICKET:",
                        "1️⃣ Cliquez bouton orange 'Nouveau Ticket'",
                        "2️⃣ Remplissez le formulaire:",
                        "   • 📝 Titre descriptif (obligatoire)",
                        "   • 🏭 Machine concernée",
                        "   • 🎯 Priorité (Critique → Normale)",
                        ...
                        "",
                        "✅ VALIDATION:",
                        "• ID auto-généré: IGP-PDE-20250118-001",
                        "• Statut initial: 'Requête Reçue'",
                        "• Notification envoyée aux techniciens",
                        "",
                ...
                details_ticket: {
                    ...
                    content: [
                        ...
                        "• ⏰ Dates (création, deadline, résolution)",
                        "• ⏱️ Timer temps restant",
                        "",
                        "📜 HISTORIQUE COMPLET:",
                ...
                commentaires: {
                    ...
                    content: [
                        ...
                        '2️⃣ Scroller vers le bas',
                        '3️⃣ Zone de texte Ajouter un commentaire',
                        '4️⃣ Taper votre message',
                        '5️⃣ Clic Ajouter le commentaire',
                        '',
                        '🎯 BONNES PRATIQUES:',
                        '• Documenter chaque action importante',
                        '• Expliquer diagnostic/réparation',
                        '• Signaler blocages ou problèmes',
                        '• Demander infos supplémentaires',
                        '',
                        '👀 VISIBILITÉ:',
                ...
                medias: {
                    ...
                    content: [
                        ...
                        "",
                        "➕ APRÈS CRÉATION:",
                        "• Ouvrir ticket → Bouton 'Ajouter médias'",
                        "• Sélectionner plusieurs fichiers",
                        "• Upload automatique",
                        "",
                        "👁️ VISUALISATION:",
                        "• Miniatures dans la carte ticket",
                        "• Clic = vue plein écran",
                        "• Zoom et navigation",
                        "• 🎥 Vidéos: lecture intégrée",
                        "",
                        "📏 LIMITES:",
                        "• Max 10MB par fichier",
                        "• Formats: JPG, PNG, MP4, MOV",
                        "• Plusieurs médias par ticket OK",
                        "",
                        "💡 Photo = 1000 mots pour diagnostic!"
                    ]
                },
                messagerie: {
                    ...
                    content: [
                        ...
                        '🔒 MESSAGES PRIVÉS:',
                        '• Conversation 1-à-1',
                        '• Sélectionner contact dans la liste',
                        '• Historique complet conservé',
                        '• Compteur messages non-lus',
                        '',
                        '🎤 MESSAGES AUDIO:',
                        '• 🔴 Maintenir bouton micro',
                        '• Parler (max 60 secondes)',
                        '• Relâcher pour envoyer',
                        '• Lecture directe dans le chat',
                        '',
                        '✍️ MESSAGES TEXTE:',
                        '• Taper dans zone de saisie',
                        '• ↵ Enter pour envoyer',
                        '• Formatage simple supporté',
                        '',
                        '🔔 NOTIFICATIONS:',
                        '• Badge rouge sur icône messagerie',
                        '• Compteur messages non-lus',
                ...
                machines: {
                    ...
                    content: [
                        '🎯 ACCÈS:',
                        '• Bouton Machines dans menu principal',
                        '• Modal liste complète des équipements',
                        '',
                        ...
                        '',
                        '➕ CRÉER UNE MACHINE:',
                        '• Bouton orange Nouvelle Machine',
                        '• Remplir nom, type, localisation',
                        '• Validation et ajout à la liste',
                        '',
                        '✏️ MODIFIER:',
                        '• Bouton bleu Modifier sur la machine',
                        '• Éditer les informations',
                        '• Sauvegarder les changements',
                        '',
                        '🗑️ SUPPRIMER:',
                        '• Bouton rouge Supprimer',
                        '• ⚠️ Impossible si tickets actifs liés',
                ...
                recherche: {
                    ...
                    content: [
                        '🔎 BARRE DE RECHERCHE:',
                        '• En haut du tableau Kanban',
                        '• Résultats instantanés lors de la frappe',
                        '',
                        '📝 RECHERCHE PAR:',
                        '• 🆔 ID ticket (IGP-PDE-...)',
                        '• 📝 Titre du ticket',
                        '• 🏭 Nom de la machine',
                        '• 👤 Nom créateur/technicien',
                        '',
                        '🎨 FILTRES PRIORITÉ:',
                        '• 🔴 Critique',
                        '• 🟠 Élevée',
                        '• 🟡 Moyenne',
                        '• 🟢 Normale',
                        '• Clic sur badge = filtrer',
                        '',
                        '📊 FILTRE PAR STATUT:',
                        '• Clic sur titre de colonne',
                        '• Affiche seulement ce statut',
                        '• Clic à nouveau = réafficher tout',
                        '',
                        '⌨️ RACCOURCIS:',
                ...
                gestion_users: {
                    ...
                    content: [
                        ...
                        '',
                        '🎯 ACCÈS:',
                        '• Bouton violet Utilisateurs en haut',
                        '• Liste complète des comptes',
                        '',
                        '🔍 RECHERCHE:',
                        '• Barre en haut du modal',
                        '• Filtrer par nom ou email',
                        '• ⎋ Escape pour effacer',
                        '',
                        '➕ CRÉER UN UTILISATEUR:',
                        '1️⃣ Bouton orange Nouvel Utilisateur',
                        '2️⃣ Remplir le formulaire:',
                        '   • 👤 Nom complet',
                        '   • 📧 Email (unique)',
                        '   • 🔑 Mot de passe (6+ chars)',
                        '   • 🎭 Rôle (14 choix)',
                        '3️⃣ Valider et créer',
                        '',
                        '✏️ MODIFIER:',
                        '• Bouton bleu Modifier',
                        '• Changer nom, email ou rôle',
                        '• Sauvegarder modifications',
                        '',
                        '🔑 RÉINITIALISER MOT DE PASSE:',
                        '• Bouton jaune MdP',
                        '• Entrer nouveau (6+ chars)',
                        '• Confirmation requise',
                        '',
                        '🗑️ SUPPRIMER:',
                        '• Bouton rouge Supprimer',
                        ...
                        '• Action irréversible',
                        '',
                        '💡 Gérez les accès avec précaution!'
                    ]
                },
                mobile: {
                    ...
                    content: [
                        ...
                        '• Même URL: mecanique.igpglass.ca',
                        '',
                        '👆 INTERACTIONS TACTILES:',
                        '• Tap sur carte = Ouvrir détails',
                        '• Swipe = Scroller horizontalement',
                        '• Pull-to-refresh (bientôt)',
                        '',
                        '🎬 DÉPLACER TICKETS:',
                        '• Tap sur carte',
                        '• Menu Changer statut',
                        '• Sélectionner nouvelle colonne',
                        ...
                        '',
                        '🎤 MESSAGES AUDIO:',
                        '• Bouton micro dans messagerie',
                        '• Maintenir pour enregistrer',
                        '• Relâcher pour envoyer',
                        '• Parfait pour terrain!',
                        '',
                        '🤏 GESTES:',
                        '• Pinch = Zoom sur photos',
                        '• Swipe = Navigation',
                        '• Long-press = Menu contextuel',
                        '',
                        '⚡ OPTIMISATIONS MOBILE:',
                        '• Menu hamburger compact',
                        '• Boutons taille pouce',
                        '• Chargement progressif',
                        '• Mode sombre automatique',
                        '',
                        '💡 Travaillez efficacement sur terrain!'
                    ]
                },
                raccourcis: {
                    ...
                    content: [
                        ...
                        '• ⎋ Escape (recherche) = Effacer',
                        "• ↹ Tab = Champ suivant",
                        "• ⇧ Shift + Tab = Champ précédent",
                        "• ↵ Enter = Valider formulaire",
                        "",
                        "🎯 ASTUCES INTERFACE:",
                        "• Auto-focus sur champs importants",
                        "• Commencer à taper directement",
                        "• Navigation formulaire au clavier",
                        "",
                        "💬 MESSAGERIE:",
                        ...
                        "",
                        "🔍 RECHERCHE:",
                        "• Commencer à taper = recherche active",
                        "• ⎋ Escape = Réinitialiser filtres",
                        "",
                        "⏳ INDICATEURS VISUELS:",
                        "• Spinner = Chargement en cours",
                        "• Toast vert = Action réussie",
                        "• Toast rouge = Erreur",
                        "• Toast disparaît après 3 secondes",
                        "",
                        "💡 Maîtrisez les raccourcis = +50% vitesse!"
                    ]
                },
                securite: {
                    ...
                    content: [
                        "🔐 AUTHENTIFICATION:",
                        "• Cookies HttpOnly sécurisés",
                        "• Sessions 7 ou 30 jours",
                        "• Mot de passe: 6+ caractères minimum",
                        "• Cryptage PBKDF2 (100k itérations)",
                        "",
                        "🌐 CONNEXION:",
                        "• HTTPS obligatoire (cryptage SSL/TLS)",
                        ...
                        "• Vérifiez votre rôle avant actions",
                        "• Signalez comportements suspects",
                        "",
                        "💡 Sécurité = responsabilité collective!"
                    ]
                },
                problemes: {
                    title: "🆘 Dépannage",
                    ...
                    content: [
                        ...
                        "• Autoriser accès micro dans navigateur",
                        "• Vérifier paramètres système",
                        "• Tester avec autre navigateur",
                        "",
                        "🖱️ DRAG & DROP NE MARCHE PAS:",
                        "• Utiliser menu contextuel (clic droit)",
                        "• Sur mobile: menu Changer statut",
                        "• Vérifier permissions de votre rôle",
                        "",
                        "🌐 NAVIGATEURS RECOMMANDÉS:",
                        "• ✅ Chrome (meilleur performance)",
                        "• ✅ Firefox",
                        "• ✅ Edge",
                        "• ✅ Safari (iOS)",
                        "• ⚠️ IE11 non supporté",
                        "",
                        "📱 PROBLÈMES MOBILE:",
                        "• Mettre à jour navigateur mobile",
                        "• Vider cache application",
                        "• Vérifier version iOS/Android récente",
                        "",
                        "❌ AUTRE PROBLÈME:",
                ...
                nouveautes: {
                    title: "🚀 Nouveautés & Historique",
                    icon: "fa-history",
                    color: "green",
                    content: [
                        "📅 VERSION 2.5.4 (Janvier 2025)",
                        "",
                        "🆕 REMEMBER ME:",
                        ...
                        "",
                        "💬 v2.0: Système messagerie",
                        "• Messages publics et privés",
                        "• Messages audio (60s)",
                        "• Notifications temps-réel",
                        "",
                        "🏭 v1.8: Gestion machines",
                        "• CRUD complet équipements",
                        "• Liaison tickets-machines",
                        "",
                        "🎨 v1.5: Refonte UI",
                ...
                contact: {
                    ...
                    content: [
                        "🆘 SUPPORT TECHNIQUE:",
                        "• Administrateur système IGP",
                        "• Disponible heures ouvrables",
                        "• Temps réponse < 2h",
                        "",
                        "📧 COORDONNÉES:",
                        "• Email: [Configurer dans settings]",
                        "• Téléphone: [Configurer dans settings]",
                        "• En personne: Bureau maintenance",
                        "",
                        "🐛 SIGNALER UN BUG:",
                        "• Décrire le problème précisément",
                        "• Indiquer: date, heure, action effectuée",
                        "• Joindre capture écran si possible",
                        "• Mentionner navigateur/appareil utilisé",
                        "",
                        "💡 SUGGESTIONS D'AMÉLIORATION:",
                        "• Toute idée est bienvenue!",
                        "• Partagez votre expérience",
                        "• Proposez nouvelles fonctionnalités",
                        "",
                        "🎓 RESSOURCES:",
                        "• 🌐 mecanique.igpglass.ca",
                        "• 📖 Ce guide utilisateur (? en haut)",
                        "• 🏷️ Version actuelle: 2.5.4",
                        "• 📅 Dernière MàJ: Janvier 2025",
                        "",
                        "🏢 À PROPOS:",
                        "• IGP Glass - Les Produits Verriers International",
                        "• Système développé sur-mesure",
                        "• Cloudflare Pages (edge computing)",
                        "• React + Hono + D1 Database",
                        "",
            ...
            const menuItems = [
                { id: 'introduction', icon: 'fa-home', label: 'Bienvenue' },
                ...
                { id: 'messagerie', icon: 'fa-comments', label: 'Messagerie' },
                { id: 'machines', icon: 'fa-cogs', label: 'Gestion Machines' },
                { id: 'recherche', icon: 'fa-search', label: 'Recherche & Filtres' },
                { id: 'gestion_users', icon: 'fa-users-cog', label: 'Gestion Utilisateurs' },
                { id: 'mobile', icon: 'fa-mobile-alt', label: 'Version Mobile' },
                { id: 'raccourcis', icon: 'fa-keyboard', label: 'Raccourcis Clavier' },
                { id: 'securite', icon: 'fa-shield-alt', label: 'Sécurité' },
                { id: 'nouveautes', icon: 'fa-history', label: 'Nouveautés v2.5.4' },
                { id: 'problemes', icon: 'fa-wrench', label: 'Dépannage' },
                { id: 'contact', icon: 'fa-life-ring', label: 'Support' }
            ];
                                    ...
                                    React.createElement('div', { className: 'space-y-4' },
                                        ...
                                        React.createElement('div', {},
                                            ...
                                            scheduledDate ? React.createElement('div', { className: 'mt-2 text-xs text-gray-600 italic' },
                                                '💡 Cliquez sur Retirer pour passer de PLANIFIE a ASSIGNE'
                                            ) : null
