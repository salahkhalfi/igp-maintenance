...
<head>
    ...
    <link rel="preload" href="/static/js/dist/utils.min.js?v=ccf7720a" as="script">
    <link rel="preload" href="/static/js/dist/App.min.js?v=ccf7720a" as="script">
    <link rel="preload" href="/static/js/dist/LoginForm.min.js?v=ccf7720a" as="script">
    <link rel="preload" href="/static/js/dist/KanbanBoard.min.js?v=ccf7720a" as="script">
    <link rel="preload" href="/static/js/dist/AppHeader.min.js?v=ccf7720a" as="script">
    ...
    <script src="/static/js/dist/utils.min.js?v=ccf7720a"></script>

    <script src="/static/js/dist/NotificationModal.min.js?v=ccf7720a"></script>
    <script src="/static/js/dist/ConfirmModal.min.js?v=ccf7720a"></script>
    <script src="/static/js/dist/Toast.min.js?v=ccf7720a"></script>
    <script src="/static/js/dist/TicketTimer.min.js?v=ccf7720a"></script>
    <script src="/static/js/dist/ScheduledCountdown.min.js?v=ccf7720a"></script>
    <script src="/static/js/dist/UserGuideModal.min.js?v=ccf7720a"></script>
    <script src="/static/js/dist/PromptModal.min.js?v=ccf7720a"></script>
    <script src="/static/js/dist/LoginForm.min.js?v=ccf7720a"></script>
    <script src="/static/js/dist/MoveTicketBottomSheet.min.js?v=ccf7720a"></script>
    <script src="/static/js/dist/CreateTicketModal.min.js?v=ccf7720a"></script>
    <script src="/static/js/dist/TicketDetailsModal_v3.min.js?v=ccf7720a"></script>
    <script src="/static/js/dist/ErrorBoundary.min.js?v=ccf7720a"></script>
    <script src="/static/js/dist/MachineManagementModal.min.js?v=ccf7720a"></script>
    <script src="/static/js/dist/RoleDropdown.min.js?v=ccf7720a"></script>
    <script src="/static/js/dist/SystemSettingsModal.min.js?v=ccf7720a"></script>
    <script src="/static/js/dist/PerformanceModal.min.js?v=ccf7720a"></script>
    <script src="/static/js/dist/AIChatModal_v4.min.js?v=ccf7720a"></script>
    <script src="/static/js/dist/OverdueTicketsModal.min.js?v=ccf7720a"></script>
    <script src="/static/js/dist/PushDevicesModal.min.js?v=ccf7720a"></script>
    <!-- MISSING SCRIPTS RESTORED -->
    <script src="/static/js/hooks/useTickets.js"></script>
    <script src="/static/js/hooks/useMachines.js"></script>
    <script src="/static/js/dist/AppHeader.min.js?v=ccf7720a"></script>
    ...
    <script src="/static/js/dist/ProductionPlanning_v3.min.js?v=ccf7720a"></script>
    <script src="/static/js/dist/KanbanBoard.min.js?v=ccf7720a"></script>
    <script src="/static/js/dist/AdminRoles.min.js?v=ccf7720a"></script>
    <script src="/static/js/dist/ManageColumnsModal.min.js?v=ccf7720a"></script>
    <script src="/static/js/dist/TicketComments.min.js?v=ccf7720a"></script>
    <script src="/static/js/dist/TicketAttachments.min.js?v=ccf7720a"></script>
    <script src="/static/js/dist/UserForms.min.js?v=ccf7720a"></script>
    <script src="/static/js/dist/UserList.min.js?v=ccf7720a"></script>
    <script src="/static/js/dist/UserManagementModal.min.js?v=ccf7720a"></script>
    <script src="/static/js/dist/VoiceTicketFab.min.js?v=ccf7720a"></script>
    <script src="/static/js/dist/MainApp.min.js?v=ccf7720a"></script>
    <script src="/static/js/dist/App.min.js?v=ccf7720a"></script>
...
<body>
    ...
    <script>
        ...
        */
        ...
        // getStatusLabel - DÉPLACÉ VERS /static/js/dist/utils.min.js?v=ccf7720a


        // FONCTION UTILITAIRE CENTRALE: Obtenir l'heure EST/EDT configurée
        // DÉPLACÉ VERS /static/js/dist/utils.min.js?v=ccf7720a
        ...
        // getElapsedTime - DÉPLACÉ VERS /static/js/dist/utils.min.js?v=ccf7720a

        // Formater le texte du chronomètre avec secondes
        // formatElapsedTime - DÉPLACÉ VERS /static/js/dist/utils.min.js?v=ccf7720a


        // Composant de notification personnalisé
        // NotificationModal - DÉPLACÉ VERS /static/js/dist/NotificationModal.min.js?v=ccf7720a

        // Composant de confirmation personnalisé
        // ConfirmModal - DÉPLACÉ VERS /static/js/dist/ConfirmModal.min.js?v=ccf7720a

        // Composant Toast pour notifications rapides
        // Toast - DÉPLACÉ VERS /static/js/dist/Toast.min.js?v=ccf7720a

        // Composant Chronomètre dynamique (mise à jour chaque seconde)
        // TicketTimer - DÉPLACÉ VERS /static/js/dist/TicketTimer.min.js?v=ccf7720a
        // ScheduledCountdown - DÉPLACÉ VERS /static/js/dist/ScheduledCountdown.min.js?v=ccf7720a

        // Composant Guide Utilisateur
        // UserGuideModal - DÉPLACÉ VERS /static/js/dist/UserGuideModal.min.js?v=ccf7720a
        // PromptModal - DÉPLACÉ VERS /static/js/dist/PromptModal.min.js?v=ccf7720a
        // LoginForm - DÉPLACÉ VERS /static/js/dist/LoginForm.min.js?v=ccf7720a
        // MoveTicketBottomSheet - DÉPLACÉ VERS /static/js/dist/MoveTicketBottomSheet.min.js?v=ccf7720a
        // CreateTicketModal - DÉPLACÉ VERS /static/js/dist/CreateTicketModal.min.js?v=ccf7720a
        ...
        // MachineManagementModal - DÉPLACÉ VERS /static/js/dist/MachineManagementModal.min.js?v=ccf7720a
        // RoleDropdown - DÉPLACÉ VERS /static/js/dist/RoleDropdown.min.js?v=ccf7720a
        // SystemSettingsModal - DÉPLACÉ VERS /static/js/dist/SystemSettingsModal.min.js?v=ccf7720a
        // Composant de performance des techniciens (ÉTAPE 2: VERSION BASIQUE)
        // PerformanceModal - DÉPLACÉ VERS /static/js/dist/PerformanceModal.min.js?v=ccf7720a
        // OverdueTicketsModal - DÉPLACÉ VERS /static/js/dist/OverdueTicketsModal.min.js?v=ccf7720a
        // PushDevicesModal - DÉPLACÉ VERS /static/js/dist/PushDevicesModal.min.js?v=ccf7720a
        // UserManagementModal - DÉPLACÉ VERS /static/js/dist/UserManagementModal.min.js?v=ccf7720a
        // MainApp - DÉPLACÉ VERS /static/js/dist/MainApp.min.js?v=ccf7720a
        // App - DÉPLACÉ VERS /static/js/dist/App.min.js?v=ccf7720a
