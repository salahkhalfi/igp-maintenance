...
<head>
    ...
    <link rel="preload" href="/static/js/dist/AppHeader.min.js?v=eec20b9" as="script">
    ...
    <script src="/static/js/dist/SecretariatModal.min.js?v=9d7852c"></script>
    ...
    <script src="/static/js/dist/AppHeader.min.js?v=eec20b9"></script>
    ...
    <script src="/static/js/dist/KanbanBoard.min.js?v=f8eef98"></script>
...
<body>
    ...
    <script>
        ...
        // SystemSettingsModal - DÉPLACÉ VERS /static/js/dist/SystemSettingsModal.min.js?v=b1605ba
