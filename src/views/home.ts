...
<head>
    ...
    <script src="/static/js/dist/AIChatModal_v4.min.js?v=d389a53"></script>
    ...
    <script src="/static/js/dist/ProductionPlanning_v3.min.js?v=05582cf"></script>
...
<body>
    ...
    <script>
        ...
        // MachineManagementModal - DÉPLACÉ VERS /static/js/dist/MachineManagementModal.min.js?v=d352264
