            ...
            <div class="flex items-center justify-between flex-wrap gap-4">
                <div class="flex items-center gap-4 flex-1">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex items-center gap-3 mt-2 text-xs sm:text-sm text-gray-500">
                            ...
                            <span class="inline-flex items-center gap-1 px-2 py-1 bg-green-50 text-green-600 rounded-md">
                                <i class="fas fa-check-circle"></i>
                                <span>8 sections</span>
                            </span>
                            <span class="inline-flex items-center gap-1 px-2 py-1 bg-purple-50 text-purple-600 rounded-md">
                ...
                <button onclick="window.location.href='/'" class="back-button flex items-center gap-2">
                    <i class="fas fa-arrow-left"></i>
                    <span class="hidden sm:inline">Retour à l'application</span>
                </button>
            </div>
        </div>
