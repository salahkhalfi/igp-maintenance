    ...
    <div class="max-w-5xl mx-auto">
        ...
        <div class="section-card" id="tickets">
            ...
            <div class="feature-box">
                ...
                <ul class="space-y-2 ml-12 text-gray-700">
                    <li>• Cliquez sur le bouton <strong>"Nouveau Ticket"</strong> en haut à droite</li>
                    ...
                    <li>• Cliquez sur <strong>"Créer le ticket"</strong></li>
                </ul>
            </div>
        ...
        <div class="section-card" id="kanban">
            ...
            <div class="feature-box">
                ...
                <ul class="space-y-2 ml-12 text-gray-700">
                    <li>• Utilisez les <strong>onglets</strong> en haut pour filtrer par type de tickets</li>
                    <li>• <strong>"Tous"</strong> : Affiche tous les tickets actifs</li>
                    <li>• <strong>"Mes Tickets"</strong> : Uniquement les tickets qui vous sont assignés</li>
                    <li>• <strong>"Urgents"</strong> : Tickets prioritaires (Critique + Haute)</li>
                    <li>• <strong>Recherche</strong> : Tapez dans la barre de recherche pour trouver un ticket spécifique</li>
                </ul>
            </div>
        </div>
        ...
        <div class="section-card" id="messages">
            ...
            <div class="feature-box">
                ...
                <ul class="space-y-2 ml-12 text-gray-700">
                    <li>• Cliquez sur l'icône <i class="fas fa-comments text-green-600"></i> <strong>"Messages"</strong> dans la barre de navigation</li>
            ...
            <div class="feature-box">
                ...
                <div class="ml-12 space-y-2 text-gray-700">
                    <div class="flex items-center gap-3">
                        ...
                        <span>Ouvrir la recherche rapide</span>
                    </div>
                    <div class="flex items-center gap-3">
                        <kbd>N</kbd>
                        <span>Nouveau ticket (quand sur la page principale)</span>
                    </div>
                    <div class="flex items-center gap-3">
                        <kbd>M</kbd>
                    ...
                    <div class="flex items-center gap-3">
                        <kbd>Esc</kbd>
                        <span>Fermer les fenêtres modales</span>
                    </div>
                </div>
            </div>
