...
2.  **Universalité** : N'ajouter ici que des principes applicables à *n'importe quel projet* Web/SaaS. Pas de spécificités métier.
3.  **Application** : Appliquer ces règles avant d'écrire le code.
