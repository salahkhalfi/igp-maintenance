// Composant de confirmation personnalisé - ARIA Enhanced
const ConfirmModal = ({ show, message, onConfirm, onCancel }) => {
    ...
    return React.createElement('div', {
        ...
        React.createElement('div', {
            ...
            React.createElement('div', { className: 'flex justify-end gap-3', role: 'group', 'aria-label': 'Actions de confirmation' },
