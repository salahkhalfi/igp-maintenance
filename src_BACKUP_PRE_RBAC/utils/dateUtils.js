...
export const hasScheduledDate = (scheduledDate) => {
...
export const formatDateEST = (dateString, includeTime = true) => {
 ...
 */
export const utcToLocalDateTime = (sqlDateTime) => {
 ...
 */
export const parseUTCDate = (sqlDateTime) => {
...
export const getCountdownInfo = (scheduledDate) => {
